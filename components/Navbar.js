  ...
  return (
    <>
      <nav
        ...
        } bg-[#192734] border-b border-b-[#22303c] transition-all duration-500 ease-in-out z-50 fixed w-full top-0 py-4 `}
      >
        <div className="container mx-auto flex justify-between items-center">
          <div className="flex items-center">
            <Link href={"/"} style={{ textDecoration: "none" }}>
              <span className="hover:bg-[#22303c] text-white w-full cursor-pointer p-1 rounded-lg">
                Viable
              </span>
            </Link>
          </div>
          <div className="flex items-center">
            ...
            <Link href={"/cart"} style={{ textDecoration: "none" }}>
              <div className="relative">
                <div className="bg-[#15202b] hover:bg-[#22303c] cursor-pointer text-white p-1 rounded-full">
